...
class RestoreSnapshot(BaseModel):
    ...
    RestoreSnapshot
    """ # noqa: E501
    properties: Optional[RestoreSnapshotProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": RestoreSnapshotProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
