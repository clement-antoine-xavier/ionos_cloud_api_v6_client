...
class UserProperties(BaseModel):
    ...
    s3_canonical_user_id: Optional[StrictStr] = Field(default=None, description="Canonical (Object storage) ID of the user for a given identity.", alias="s3CanonicalUserId")
    active: Optional[StrictBool] = Field(default=None, description="Indicates if the user is active.")
    __properties: ClassVar[List[str]] = ["firstname", "lastname", "email", "administrator", "forceSecAuth", "secAuthActive", "s3CanonicalUserId", "active"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "s3CanonicalUserId": obj.get("s3CanonicalUserId"),
