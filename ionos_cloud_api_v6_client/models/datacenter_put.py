...
class DatacenterPut(BaseModel):
    """
    DatacenterPut
    """ # noqa: E501
    properties: DatacenterPropertiesPut
    entities: Optional[DatacenterEntities] = None
    __properties: ClassVar[List[str]] = ["properties", "entities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": DatacenterPropertiesPut.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "entities": DatacenterEntities.from_dict(obj["entities"]) if obj.get("entities") is not None else None
        })
        return _obj
