...
class SecurityGroup(BaseModel):
    ...
    entities: Optional[SecurityGroupEntities] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": SecurityGroupProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "entities": SecurityGroupEntities.from_dict(obj["entities"]) if obj.get("entities") is not None else None
        })
        return _obj

from ionos_cloud_api_v6_client.models.security_group_entities import SecurityGroupEntities
# TODO: Rewrite to not use raise_errors
SecurityGroup.model_rebuild(raise_errors=False)
