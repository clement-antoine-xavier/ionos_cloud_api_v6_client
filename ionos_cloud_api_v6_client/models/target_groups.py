...
class TargetGroups(BaseModel):
    ...
    href: Optional[StrictStr] = Field(default=None, description="The URL to the object representation (absolute path).")
    items: Optional[List[TargetGroup]] = Field(default=None, description="Array of items in the collection.")
    offset: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The offset, specified in the request (if not is specified, 0 is used by default).")
    limit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The limit, specified in the request (if not specified, the endpoint's default pagination limit is used).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "items": [TargetGroup.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
