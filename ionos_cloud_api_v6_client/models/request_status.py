...
class RequestStatus(BaseModel):
    ...
    metadata: Optional[RequestStatusMetadata] = None
    __properties: ClassVar[List[str]] = ["id", "type", "href", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "metadata": RequestStatusMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
