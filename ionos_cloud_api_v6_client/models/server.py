...
class Server(BaseModel):
    ...
    entities: Optional[ServerEntities] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": ServerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "entities": ServerEntities.from_dict(obj["entities"]) if obj.get("entities") is not None else None
        })
        return _obj

from ionos_cloud_api_v6_client.models.server_entities import ServerEntities
# TODO: Rewrite to not use raise_errors
Server.model_rebuild(raise_errors=False)
