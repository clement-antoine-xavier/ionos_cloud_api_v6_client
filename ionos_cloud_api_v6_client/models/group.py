...
class Group(BaseModel):
    ...
    entities: Optional[GroupEntities] = None
    __properties: ClassVar[List[str]] = ["id", "type", "href", "properties", "entities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entities": GroupEntities.from_dict(obj["entities"]) if obj.get("entities") is not None else None
        })
        return _obj
