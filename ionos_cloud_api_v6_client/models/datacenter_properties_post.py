...
class DatacenterPropertiesPost(BaseModel):
    """
    ...
    create_default_security_group: Optional[StrictBool] = Field(default=None, description="If true, a default security group, with predefined rules, will be created for the datacenter. Default value is false.", alias="createDefaultSecurityGroup")
    __properties: ClassVar[List[str]] = ["name", "description", "location", "version", "features", "secAuthProtection", "cpuArchitecture", "ipv6CidrBlock", "createDefaultSecurityGroup"]
