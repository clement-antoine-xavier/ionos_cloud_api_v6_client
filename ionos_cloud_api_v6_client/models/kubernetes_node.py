...
class KubernetesNode(BaseModel):
    ...
    metadata: Optional[KubernetesNodeMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "metadata": KubernetesNodeMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "properties": KubernetesNodeProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
