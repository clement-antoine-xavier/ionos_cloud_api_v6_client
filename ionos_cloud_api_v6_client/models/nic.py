...
class Nic(BaseModel):
    ...
    entities: Optional[NicEntities] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": NicProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "entities": NicEntities.from_dict(obj["entities"]) if obj.get("entities") is not None else None
        })
        return _obj

from ionos_cloud_api_v6_client.models.nic_entities import NicEntities
# TODO: Rewrite to not use raise_errors
Nic.model_rebuild(raise_errors=False)
