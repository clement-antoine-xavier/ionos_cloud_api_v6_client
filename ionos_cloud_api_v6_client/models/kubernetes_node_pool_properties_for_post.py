...
class KubernetesNodePoolPropertiesForPost(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "datacenterId", "nodeCount", "serverType", "cpuFamily", "coresCount", "ramSize", "availabilityZone", "storageType", "storageSize", "k8sVersion", "maintenanceWindow", "autoScaling", "lans", "labels", "annotations", "publicIps"]
