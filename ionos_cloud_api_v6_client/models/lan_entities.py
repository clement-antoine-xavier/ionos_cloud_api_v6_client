...
class LanEntities(BaseModel):
    """
    LanEntities
    """ # noqa: E501
    nics: Optional[LanNics] = None
    __properties: ClassVar[List[str]] = ["nics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nics": LanNics.from_dict(obj["nics"]) if obj.get("nics") is not None else None
        })
        return _obj
