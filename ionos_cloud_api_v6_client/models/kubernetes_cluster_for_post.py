...
class KubernetesClusterForPost(BaseModel):
    """
    KubernetesClusterForPost
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The resource unique identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": KubernetesClusterPropertiesForPost.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
