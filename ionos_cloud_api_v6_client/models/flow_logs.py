...
class FlowLogs(BaseModel):
    ...
    items: Optional[List[FlowLog]] = Field(default=None, description="Array of items in the collection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "items": [FlowLog.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
