...
class TestBalancedNics(unittest.TestCase):
    """BalancedNics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalancedNics:
        """Test BalancedNics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalancedNics`
        """
        model = BalancedNics()
        if include_optional:
            return BalancedNics(
