...
class TestKubernetesMaintenanceWindow(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> KubernetesMaintenanceWindow:
        """Test KubernetesMaintenanceWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KubernetesMaintenanceWindow`
        """
        model = KubernetesMaintenanceWindow()
        if include_optional:
