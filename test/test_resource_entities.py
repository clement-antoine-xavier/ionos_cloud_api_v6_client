...
class TestResourceEntities(unittest.TestCase):
    """ResourceEntities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceEntities:
        """Test ResourceEntities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceEntities`
        """
        model = ResourceEntities()
        if include_optional:
