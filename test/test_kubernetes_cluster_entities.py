...
class TestKubernetesClusterEntities(unittest.TestCase):
    """KubernetesClusterEntities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KubernetesClusterEntities:
        """Test KubernetesClusterEntities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KubernetesClusterEntities`
        """
        model = KubernetesClusterEntities()
        if include_optional:
            return KubernetesClusterEntities(
    ...
    def testKubernetesClusterEntities(self):
        """Test KubernetesClusterEntities"""
