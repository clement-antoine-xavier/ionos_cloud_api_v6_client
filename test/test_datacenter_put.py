...
class TestDatacenterPut(unittest.TestCase):
    """DatacenterPut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatacenterPut:
        """Test DatacenterPut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatacenterPut`
        """
        model = DatacenterPut()
        if include_optional:
            return DatacenterPut(
                properties = ionos_cloud_api_v6_client.models.datacenter_properties_put.DatacenterPropertiesPut(
