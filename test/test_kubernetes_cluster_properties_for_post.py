...
class TestKubernetesClusterPropertiesForPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> KubernetesClusterPropertiesForPost:
        """Test KubernetesClusterPropertiesForPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KubernetesClusterPropertiesForPost`
        """
        model = KubernetesClusterPropertiesForPost()
        if include_optional:
