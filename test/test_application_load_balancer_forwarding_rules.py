...
class TestApplicationLoadBalancerForwardingRules(unittest.TestCase):
    """ApplicationLoadBalancerForwardingRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationLoadBalancerForwardingRules:
        """Test ApplicationLoadBalancerForwardingRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationLoadBalancerForwardingRules`
        """
        model = ApplicationLoadBalancerForwardingRules()
        if include_optional:
    ...
    def testApplicationLoadBalancerForwardingRules(self):
        """Test ApplicationLoadBalancerForwardingRules"""
