...
class TestPrivateCrossConnectProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrivateCrossConnectProperties:
        """Test PrivateCrossConnectProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateCrossConnectProperties`
        """
        model = PrivateCrossConnectProperties()
        if include_optional:
            return PrivateCrossConnectProperties(
                ...
                connectable_datacenters = [{"id":"<dc-id>","name":"<dc-name>","location":"<de/fra>"}]
            )
        else:
            return PrivateCrossConnectProperties(
        )
