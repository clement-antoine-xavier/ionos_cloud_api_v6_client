...
class TestNetworkLoadBalancerForwardingRule(unittest.TestCase):
    """NetworkLoadBalancerForwardingRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkLoadBalancerForwardingRule:
        """Test NetworkLoadBalancerForwardingRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkLoadBalancerForwardingRule`
        """
        model = NetworkLoadBalancerForwardingRule()
        if include_optional:
    ...
    def testNetworkLoadBalancerForwardingRule(self):
        """Test NetworkLoadBalancerForwardingRule"""
