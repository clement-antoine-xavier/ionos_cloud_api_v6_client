...
class TestApplicationLoadBalancerForwardingRule(unittest.TestCase):
    """ApplicationLoadBalancerForwardingRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationLoadBalancerForwardingRule:
        """Test ApplicationLoadBalancerForwardingRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationLoadBalancerForwardingRule`
        """
        model = ApplicationLoadBalancerForwardingRule()
        if include_optional:
    ...
    def testApplicationLoadBalancerForwardingRule(self):
        """Test ApplicationLoadBalancerForwardingRule"""
