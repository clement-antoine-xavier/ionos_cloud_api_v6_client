...
class TestBackupUnit(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BackupUnit:
        """Test BackupUnit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackupUnit`
        """
        model = BackupUnit()
        if include_optional:
            return BackupUnit(
