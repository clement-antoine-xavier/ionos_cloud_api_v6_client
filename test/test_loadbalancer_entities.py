...
class TestLoadbalancerEntities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LoadbalancerEntities:
        """Test LoadbalancerEntities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoadbalancerEntities`
        """
        model = LoadbalancerEntities()
        if include_optional:
    ...
    def testLoadbalancerEntities(self):
        """Test LoadbalancerEntities"""
