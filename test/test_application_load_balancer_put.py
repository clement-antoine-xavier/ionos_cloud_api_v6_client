...
class TestApplicationLoadBalancerPut(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApplicationLoadBalancerPut:
        """Test ApplicationLoadBalancerPut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationLoadBalancerPut`
        """
        model = ApplicationLoadBalancerPut()
        if include_optional:
    ...
    def testApplicationLoadBalancerPut(self):
        """Test ApplicationLoadBalancerPut"""
