...
class TestTargetGroupProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TargetGroupProperties:
        """Test TargetGroupProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TargetGroupProperties`
        """
        model = TargetGroupProperties()
        if include_optional:
    ...
    def testTargetGroupProperties(self):
        """Test TargetGroupProperties"""
