...
class TestBackupUnitPut(unittest.TestCase):
    """BackupUnitPut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackupUnitPut:
        """Test BackupUnitPut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackupUnitPut`
        """
        model = BackupUnitPut()
        if include_optional:
            return BackupUnitPut(
