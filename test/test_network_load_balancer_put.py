...
class TestNetworkLoadBalancerPut(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetworkLoadBalancerPut:
        """Test NetworkLoadBalancerPut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkLoadBalancerPut`
        """
        model = NetworkLoadBalancerPut()
        if include_optional:
