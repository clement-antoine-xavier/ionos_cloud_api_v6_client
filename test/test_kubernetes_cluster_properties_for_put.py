...
class TestKubernetesClusterPropertiesForPut(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> KubernetesClusterPropertiesForPut:
        """Test KubernetesClusterPropertiesForPut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KubernetesClusterPropertiesForPut`
        """
        model = KubernetesClusterPropertiesForPut()
        if include_optional:
