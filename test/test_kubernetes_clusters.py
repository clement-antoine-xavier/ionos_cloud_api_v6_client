...
class TestKubernetesClusters(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> KubernetesClusters:
        """Test KubernetesClusters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KubernetesClusters`
        """
        ...
        if include_optional:
            return KubernetesClusters(
                ...
                items = [
                    ionos_cloud_api_v6_client.models.kubernetes_cluster.KubernetesCluster(
                        ...
                        metadata = ionos_cloud_api_v6_client.models.datacenter_element_metadata.DatacenterElementMetadata(
                            ...
                            state = 'AVAILABLE', ), 
                        properties = ionos_cloud_api_v6_client.models.kubernetes_cluster_properties.KubernetesClusterProperties(
                            name = 'k8s', 
                            k8s_version = '1.15.4', 
