...
class TestKubernetesClusterForPut(unittest.TestCase):
    """KubernetesClusterForPut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KubernetesClusterForPut:
        """Test KubernetesClusterForPut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KubernetesClusterForPut`
        """
        model = KubernetesClusterForPut()
        if include_optional:
            return KubernetesClusterForPut(
                ...
                metadata = ionos_cloud_api_v6_client.models.datacenter_element_metadata.DatacenterElementMetadata(
                    ...
                    state = 'AVAILABLE', ),
                properties = ionos_cloud_api_v6_client.models.kubernetes_cluster_properties_for_put.KubernetesClusterPropertiesForPut(
                    name = 'k8s', 
                    k8s_version = '1.15.4', 
    ...
    def testKubernetesClusterForPut(self):
        """Test KubernetesClusterForPut"""
