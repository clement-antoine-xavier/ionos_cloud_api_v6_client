...
class TestApplicationLoadBalancers(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApplicationLoadBalancers:
        """Test ApplicationLoadBalancers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationLoadBalancers`
        """
        model = ApplicationLoadBalancers()
        if include_optional:
    ...
    def testApplicationLoadBalancers(self):
        """Test ApplicationLoadBalancers"""
