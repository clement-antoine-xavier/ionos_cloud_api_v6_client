...
class S3Key(BaseModel):
    ...
    metadata: Optional[S3KeyMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "metadata": S3KeyMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "properties": S3KeyProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
