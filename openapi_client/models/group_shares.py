...
class GroupShares(BaseModel):
    ...
    type: Optional[Type] = Field(default=None, description="Share representing groups and resource relationship")
    href: Optional[StrictStr] = Field(default=None, description="URL to the object representation (absolute path).")
    items: Optional[List[GroupShare]] = Field(default=None, description="Array of items in the collection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "items": [GroupShare.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
