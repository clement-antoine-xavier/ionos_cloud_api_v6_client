...
class BackupUnitPut(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['backupunit']):
            raise ValueError("must be one of enum values ('backupunit')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": BackupUnitProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
