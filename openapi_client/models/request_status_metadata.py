...
class RequestStatusMetadata(BaseModel):
    """
    ...
    targets: Optional[List[RequestTarget]] = None
    __properties: ClassVar[List[str]] = ["status", "message", "etag", "targets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "etag": obj.get("etag"),
            "targets": [RequestTarget.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None
        })
        return _obj
