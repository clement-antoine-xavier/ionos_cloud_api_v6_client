...
class SecurityGroupRequest(BaseModel):
    ...
    entities: Optional[SecurityGroupEntitiesRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entities": SecurityGroupEntitiesRequest.from_dict(obj["entities"]) if obj.get("entities") is not None else None
        })
        return _obj
