...
class SecurityGroupEntities(BaseModel):
    """
    SecurityGroupEntities
    """ # noqa: E501
    rules: Optional[FirewallRules] = None
    nics: Optional[Nics] = None
    servers: Optional[Servers] = None
    __properties: ClassVar[List[str]] = ["rules", "nics", "servers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": FirewallRules.from_dict(obj["rules"]) if obj.get("rules") is not None else None,
...
SecurityGroupEntities.model_rebuild(raise_errors=False)
