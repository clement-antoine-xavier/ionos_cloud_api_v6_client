...
class GroupShare(BaseModel):
    ...
    type: Optional[Type] = Field(default=None, description="resource as generic type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "properties": GroupShareProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
