...
class KubernetesNodePoolForPost(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['nodepool']):
            raise ValueError("must be one of enum values ('nodepool')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": KubernetesNodePoolPropertiesForPost.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
