...
class DatacenterProperties(BaseModel):
    """
    ...
    default_security_group_id: Optional[StrictStr] = Field(default=None, description="Optional property to define the default security group of the datacenter.", alias="defaultSecurityGroupId")
    __properties: ClassVar[List[str]] = ["name", "description", "location", "version", "features", "secAuthProtection", "cpuArchitecture", "ipv6CidrBlock", "defaultSecurityGroupId"]
