...
class ResourceGroups(BaseModel):
    ...
    items: Optional[List[Resource]] = Field(default=None, description="Array of items in the collection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "items": [Resource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj

from openapi_client.models.resource import Resource
# TODO: Rewrite to not use raise_errors
ResourceGroups.model_rebuild(raise_errors=False)
