...
class User(BaseModel):
    ...
    entities: Optional[UsersEntities] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": UserProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "entities": UsersEntities.from_dict(obj["entities"]) if obj.get("entities") is not None else None
        })
        return _obj
