...
class ApplicationLoadBalancer(BaseModel):
    ...
    entities: Optional[ApplicationLoadBalancerEntities] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": ApplicationLoadBalancerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "entities": ApplicationLoadBalancerEntities.from_dict(obj["entities"]) if obj.get("entities") is not None else None
        })
        return _obj
